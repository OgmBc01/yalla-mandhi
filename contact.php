...
<head>
    ...
    <title>Contact & Reservations | Yalla Al Mandhi - Book Your Table</title>
    <meta name="description" content="Contact Yalla Al Mandhi for reservations, catering inquiries, or general questions. Book your table for an authentic Yemani dining experience.">
    ...
    <nav class="navbar" id="navbar">
        <div class="nav-container">
            ...
            <div class="nav-links">
                ...
                <a href="contact.html" class="nav-link active">Contact / Reservations</a>
            </div>
