            ...
            <div class="card-body">
                    <form method="GET" action="" class="row g-3 align-items-end">
                        ...
                        <div class="col-md-4 d-flex align-items-end">
                            ...
                            <a href="includes/export_report.php?source=vendor&export=pdf&start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>" class="btn btn-danger" target="_blank">
