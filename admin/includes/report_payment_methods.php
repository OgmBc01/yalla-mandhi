            ...
            <div class="card-body">
                <form method="GET" action="" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-4 d-flex gap-2">
                        ...
                        <a href="includes/export_report.php?source=payment&export=csv&start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>" class="btn btn-success" target="_blank">
                            <i class="bi bi-file-earmark-excel"></i> CSV
                        </a>
                        <a href="includes/export_report.php?source=payment&export=pdf&start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>" class="btn btn-danger" target="_blank">
