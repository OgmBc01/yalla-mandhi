...
<head>
    ...
    <title>Offers & Promotions | Yalla Al Mandhi - Special Deals & Discounts</title>
    <meta name="description" content="Discover exclusive offers, promotions, and special deals at Yalla Al Mandhi. Family packages, happy hours, and seasonal discounts on authentic Yemani cuisine.">
            ...
            <div class="nav-links">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="offers.html" class="dropdown-item active">Offers & Promotions</a>
                ...
                <a href="catering.html" class="nav-link">Catering & Events</a>
            ...
            <div class="footer-grid">
                ...
                <div>
                    ...
                    <div class="social-links">
                        ...
                        <a href="https://wa.me/971503757274" target="_blank" class="social-icon">
                ...
                <div>
                    ...
                    <ul class="footer-links">
                        ...
                        <li style="display: flex; align-items: center; gap: 10px; margin-bottom: 15px;">
                            ...
                            <span>+971 50 375 7274</span>
                        </li>
                        <li style="display: flex; align-items: center; gap: 10px; margin-bottom: 15px;">
                            <i class="bi bi-whatsapp" style="color: var(--color-red);"></i>
                            <span>+971 50 375 7274</span>
                        </li>
