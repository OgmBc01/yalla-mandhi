...
NULL
delivery_source
enum('internal','noon','deliveroo','keeta','smile')
YES
MUL
NULL
table_number
...
NULL
order_status
enum('draft','pending','confirmed','in_preparation','ready','out_for_delivery','completed','cancelled','refunded','closed')
NO
MUL
draft
payment_method
